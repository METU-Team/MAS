...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--eval_interval", type=int, default=20_000,
                        ...
                        "matches the MADDPG/history paths for cross-paradigm plots).")
...
def _maybe_create_wandb_logger(args, config_payload: dict) -> Optional[WandbLogger]:
    ...
    group = args.wandb_group or "mappo_{}".format(args.scenario)
    return WandbLogger(
...
def main() -> None:
    ...
    def _on_log(record: dict) -> None:
        print(
            ...
            "  episodes={episode_count:>5d}  updates={update_count}".format(**record)
        )
